...
try:
    conn = mysql.connector.connect(
           host='DavidGR.mysql.pythonanywhere-services.com',
           user='DavidGR',
           password='mysqlroot'
      )
...
cursor.execute("DROP DATABASE IF EXISTS `DavidGR$pedidoEntrega`;")

cursor.execute("CREATE DATABASE `DavidGR$pedidoEntrega`;")

cursor.execute("USE `DavidGR$pedidoEntrega`;")
...
cursor.execute('select * from DavidGR$pedidoEntrega.usuarios')
print(' -------------  Usuarios:  -------------')
...
cursor.execute('select * from DavidGR$pedidoEntrega.productos')
print(' -------------  Productoss:  -------------')
